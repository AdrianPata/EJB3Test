...
public class QuizWebService {
    @EJB(mappedName="ejb:/ejb3-server-war-1.0-SNAPSHOT/PlayedQuizzesCounterBean!ro.pata.test.ejb.server.api.IRemotePlayedQuizzesCounter")
